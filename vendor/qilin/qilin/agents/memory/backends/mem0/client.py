...
The MemoryManager contract is synchronous (QiLinMem's LLM calls are sync too),
...
class Mem0Client:
    """Thin wrapper over the mem0 endpoints QiLin uses."""
    ...
    def ping(self) -> None:
        ...
        """
        self.list_memories(filters={"user_id": "__qilin_startup_check__"}, page_size=1, max_items=1)
