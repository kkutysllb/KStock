...
from qilin.agents.middlewares.tool_result_meta import normalize_tool_result
from qilin.sandbox.tools import read_current_file_content

logger = logging.getLogger(__name__)

READ_MARK_KEY = "qilin_read_mark"
        ...
        if name in _GATED_WRITE_TOOLS:
            ...
            with self._lock_for(request, path):
                ...
                if blocked is not None:
                    # Stamp qilin_tool_meta so ToolProgressMiddleware can classify
