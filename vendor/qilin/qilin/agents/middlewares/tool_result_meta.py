...
``qilin_tool_meta`` entry in additional_kwargs. Downstream consumers
...
def stamp_exception_meta(msg: ToolMessage, exc_info: str) -> ToolMessage:
    """Stamp qilin_tool_meta with source='exception' onto an exception-derived ToolMessage.
...
def normalize_tool_message(msg: ToolMessage) -> ToolMessage:
    """Attach qilin_tool_meta to a ToolMessage if not already present."""
