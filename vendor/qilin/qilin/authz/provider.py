...
deliberately kept as a sibling to :mod:`qilin.guardrails` rather than folded
...
2. **Run-time execution deny** — reuses :class:`~qilin.guardrails.middleware.GuardrailMiddleware`
   via a thin adapter (see :mod:`qilin.authz.adapter`), catching dynamic
...
class AuthorizationProvider(Protocol):
    ...
    mechanism QiLin uses for models, tools, sandbox, and guardrails.
