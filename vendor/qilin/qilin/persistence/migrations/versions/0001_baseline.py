"""baseline -- chain root for QiLin application schema.
...
every QiLin-owned table at the point alembic was wired in. Under the hybrid
bootstrap strategy (``qilin.persistence.bootstrap.bootstrap_schema``), the
