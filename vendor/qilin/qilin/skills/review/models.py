...
PACKAGE_SNAPSHOT_SCHEMA_VERSION = "qilin.skill-package-snapshot.v1"
FACTS_SCHEMA_VERSION = "qilin.skill-review.facts.v1"
REPORT_SCHEMA_VERSION = "qilin.skill-review.report.v1"

Severity = Literal["blocker", "error", "warning", "info"]
ProfileName = Literal["qilin", "agentskills"]
